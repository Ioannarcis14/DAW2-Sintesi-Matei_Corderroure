...
(function (d) {
    function r(e, c, l, b, a) {
        ...
        if (p.filter(":visible").length == e && !u.length && !c) {
            ...
            if (1 == p.length)
                return (
                    "list" == a.layoutMode ? (b.addClass(a.listClass), b.removeClass(a.gridClass), m.css("display", a.targetDisplayList)) : (b.addClass(a.gridClass), b.removeClass(a.listClass), m.css("display", a.targetDisplayGrid)),
                        f(),
                        !1
                );
        }
            ...
            return this.each(function () {
                ...
                if (b.sortOnLoad) {
                    ...
                    d.isArray(b.sortOnLoad)
                        ? ((c = b.sortOnLoad[0]), (f = b.sortOnLoad[1]), d(b.sortSelector + "[data-sort=" + b.sortOnLoad[0] + "][data-order=" + b.sortOnLoad[1] + "]").addClass("active"))
                        : (d(b.sortSelector + "[data-sort=" + b.sortOnLoad + "]").addClass("active"), (c = b.sortOnLoad), (b.sortOnLoad = "desc"));
                    x(c, f, a, b);
                }
                for (f = 0; 2 > f; f++)
                    (c = 0 == f ? (c = b.prefix) : ""),
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        "list" == b.layoutMode
                            ? g.removeStyle(b.prefix + "transition, transition").css({ display: b.targetDisplayList, opacity: 1 })
                            : g.removeStyle(b.prefix + "transition, transition").css({ display: b.targetDisplayGrid, opacity: 1 });
                        b.mixing = !1;
